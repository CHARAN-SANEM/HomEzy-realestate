...
import { updateUserStart,updateUserSuccess,updateUserFailure, signOutUserStart, signOutUserFailure, signOutUserSuccess, deleteUserFailure, deleteUserStart, deleteUserSuccess } from "../redux/user/userSlice";
...
<p className='text-sm self-center'>
        ...
        <button disabled={loading} className='bg-slate-700 text-white p-3 rounded-lg uppercase hover:opacity-90 disabled:opacity-80' >{loading ? 'loading....':'update'}</button>
      ...
      <p className="text-green-600 mt-5">{updateSuccess ?'user is updated ' : '' }</p>
